    ...
    if(industry_type == "N"):
        ...
        for i in range(1, len(reports)):
            ...
            if(check_report_type(reports_sorted[i][0]) == "Q"):
                ...
                # Get revenues
                #print("Revenue")    
                if not np.isnan(extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", "true", position_income[0])):
                    result_data[6][i - 1] = extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", "true", position_income[0])
                elif not np.isnan(extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", None, position_income[0])):
                    result_data[6][i - 1] = extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", None, position_income[0])
                else:
                ...
                if not np.isnan(extract_data(table_operations[i - 1][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", "true", position_income[1])):
                    previous_revenues = extract_data(table_operations[i - 1][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", "true", position_income[1])
                elif not np.isnan(extract_data(table_operations[i - 1][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", None, position_income[1])):
                    previous_revenues = extract_data(table_operations[i - 1][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", None, position_income[1])
                else:
                    pass
                ...
                if not np.isnan(extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", "true", position_income[2])):
                    year_revenues = extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", "true", position_income[2])
                elif not np.isnan(extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", None, position_income[2])):
                    year_revenues = extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", None, position_income[2])
                else:
                    pass
...
#             """
            ...
            if(check_report_type(reports_sorted[i][0]) == "Q"):
                ...
                # Get revenues                
                if not np.isnan(extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", "true", position_income[0])):                    
                    result_data[10][i - 1] = extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", "true", position_income[0])
                elif not np.isnan(extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", None, position_income[0])):
                    result_data[10][i - 1] = extract_data(table_operations[i][1], r"^us-gaap:Revenues$|^us-gaap:RevenueFromContractWithCustomerExcludingAssessedTax$|^us-gaap:RevenuesNetOfInterestExpense$", None, position_income[0])
                else:
                    result_data[10][i - 1] = np.nan
...
# get_ipython().system('jupyter nbconvert ME_American_Stock_Analysis_v1.2.ipynb --to python')
