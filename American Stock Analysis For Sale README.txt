...
2. pyinstaller American_Stock_Analysis_For_Sale.py --icon=elephant_no_bg.ico
   (icon=... 設定.exe檔的圖示)
3. 轉換成功後，將相關的檔案放入新建立的folder中(elephant_no_bg.ico、info.json、logout/open/stop.png、同edge版本的msedgedriver)
